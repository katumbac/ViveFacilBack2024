...
urlpatterns += [
    ...
    path('notificacion-anuncio/<int:pk>/envio/', Notificaciones_Details.as_view(), name='envio_notificacion'),
    ...
    path('notificacion-anuncio/<int:pk>/envio/', SendNotificacion_Details.as_view(), name='envio_notificacion'),
